                ...
                <tbody>
                  {paginatedAppointments.map((appointment, index) => (
                    <tr key={appointment._id}>
                      ...
                      <td>{appointment.userId?.gender || 'N/A'}</td>
                      <td>{appointment.userId?.mobile || 'N/A'}</td>
                      <td>{appointment.userId?.bloodGroup || 'N/A'}</td>
                      <td>{appointment.userId?.familyDiseases || 'N/A'}</td>
